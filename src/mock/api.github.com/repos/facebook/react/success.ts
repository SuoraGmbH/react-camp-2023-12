...
export const githubApiReposFacebookReactSuccessMock = http.get(
  ...
  () => {
    return HttpResponse.json({
      ...
      updated_at: "2023-12-06T14:21:12Z",
      pushed_at: "2023-12-05T19:15:24Z",
